...
class PowerGrid(gym.Env):
  ...
  def _call_lopf(self):
    try:
      lopf_status = self.network.lopf(pyomo=False,solver_name='gurobi',solver_options = {'OutputFlag': 0,'LicenseID':'791591','TokenServer':''},solver_logfile=None,store_basis = False,warmstart = False)
